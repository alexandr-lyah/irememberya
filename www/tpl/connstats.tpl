	<div class="rounded center marginTop40px" style="width:90%; padding:20px; text-align:left;">
		...
		<p style="line-height:35px;" class="marginTop10px">
			...
			Your connections were described with a total of <strong class="blue">{$numskillsreceived}</strong> Skills by <strong class="blue">{$numskillsreceivedfrom}</strong> of their connections. On the other way around, they used <strong class="blue">{$numskillssent}</strong> Skills to describe <strong class="blue">{$numskillssentto}</strong> of their connections.
			<br />
			 <strong class="blue">{$numactiveconns}</strong> of your  <strong class="blue">{$numconns}</strong> connections {if $numactiveconns == 1}is{else}are{/if} actively using Top3Skills.com and this means that you should invite the other <strong class="blue">{$numnonactiveconns}</strong> connections to start using Top3Skills.com.
			...
			<div class="marginTop20px"> 
				...
				{foreach $connreferences as $user}
			            <div class="{cycle values="left lightbluebackground, left"}" style="padding:15px;">
			                ...
			                <div style="display:inline-block; vertical-align:middle; margin-left:5px; line-height:25px; width:400px;" >								 
